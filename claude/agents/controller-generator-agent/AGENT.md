...
description: Generar controladores Express completos y seguros
type: agent
---

## Responsabilidad

Crea controladores con validación, error handling y tipos correctos

## Cuándo Invocar

```
controller-generator-agent: [instrucción específica]
```
