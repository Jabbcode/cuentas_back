...
description: Procesar datos complejos con múltiples relaciones
type: agent
---

## Responsabilidad

Crea lógica para procesar datos complejos y agregaciones

## Cuándo Invocar

```
data-processing-agent: [instrucción específica]
```
